# Reflect: Trail Completion Invariants and the [REFLECT] Phase
...
1. **The Reflect Synthesis Invariant**: The friction, pitfalls, and architectural drifts discovered during the execution of the trail must be physically condensed (Reflect) and locked to the Ledger. This ensures the next trail inherits the wisdom, not just the code.
