...
```text
├── node_4c_probe_anchor_compilation [BLOCKED] [PROBE]: Probe Anchor Compilation Invariant
...
├── node_22_probe_retro_css_formatting [IN_REVIEW] [PROBE]: Probe RETRO CSS Formatting
```
